(function (global) {
    ...
    function fixUrl(urlStr, config, location) {
        ...
        if (urlStr.substr(0, config.prefix.length) === config.prefix) {
            if((urlStr.includes("hls/videos/") && !urlStr.includes("https://waiting-bright-crib.onrender.com") && !urlStr.includes(".m3u8")) || 
               (urlStr.includes("/hls/") && !urlStr.includes("https://waiting-bright-crib.onrender.com") && !urlStr.includes(".m3u8"))
              ){
